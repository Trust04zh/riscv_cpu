...
`define REG_WRITE_PC_PLUS_4 3'b010
...
`define INST_ATTR_JAL {`PC_UPDATE_JUMP, `CACHE_D_WRITE_DISABLED, `CACHE_D_WRITE_DONT_CARE, `CACHE_D_READ_DONT_CARE, `ALU_SRC2_DONT_CARE, `IMM_2_EXTEND_DONT_CARE, `ALU_OP_NONE, `REG_WRITE_ENABLED, `REG_WRITE_PC_PLUS_4, `INST_FMT_J}

`define INST_MASK_JALR `INST_FMT_I_MASK
`define INST_PATT_JALR 32'b0000000_00000_00000_000_00000_1100111
`define INST_ATTR_JALR {`PC_UPDATE_JR, `CACHE_D_WRITE_DISABLED, `CACHE_D_WRITE_DONT_CARE, `CACHE_D_READ_DONT_CARE, `ALU_SRC2_IMM, `IMM_2_EXTEND_12, `ALU_OP_ADD, `REG_WRITE_ENABLED, `REG_WRITE_PC_PLUS_4, `INST_FMT_I} 
